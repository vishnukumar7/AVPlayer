...
import com.app.avplayer.activity.VideoPlayActivity
...
class CustomExoVideoPlayer : FrameLayout, DownloadListener, View.OnTouchListener {
    ...
    private lateinit var activity: VideoPlayActivity
    ...
    private fun init(context1: Context) {
        if (videoPlayer == null) {
         ...
         TrackSelector trackSelector =
            ...
            videoSurfaceView!!.setOnTouchListener(this)
    ...
    fun playVideo(videoActivity: VideoPlayActivity, videoURL: String) {
        ...
        videoPlayer!!.prepare()
        videoPlayer!!.playWhenReady = true
        videoSurfaceView!!.defaultArtwork =
            context.getDrawable(R.drawable.exo_ic_default_album_image)
