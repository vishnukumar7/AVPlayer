...
import com.app.medialoader.data.file.BufferedRandomAccessFile
import kotlin.Throws
import com.app.medialoader.data.file.BufferRAFileDataSource
import com.app.medialoader.data.file.cleanup.DiskLruCache
import java.io.File
import java.io.IOException

/**
 * [BufferedRandomAccessFile]实现
 *
 * @author vincanyang
 */
class BufferRAFileDataSource(file: File, diskLruStorage: DiskLruCache) :
    BaseFileDataSource(file, diskLruStorage) {
    private var mRandomAccessFile: BufferedRandomAccessFile
    ...
    private fun renameCompletedFile() {
        ...
        mRandomAccessFile = BufferedRandomAccessFile(mOriginFile, "r")
    }
    ...
    init {
        ...
        mRandomAccessFile = BufferedRandomAccessFile(mOriginFile, if (completed) "r" else "rw")
    }
}